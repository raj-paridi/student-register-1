...
class Students extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('father_name,father_occupation,father_income,father_mobile,mother_name,mother_occupation', 'required', 'on'=>'parental_details_enter'),
	...
	public function otpvalidate($attribute,$params)
   {
	...
	public function attributeLabels()
	{
		return array(
			...
			'last_name' => 'Sur Name(names without".",with spaces only)',
			...
			'father_income' => 'Father Income(Annual)',
			'mother_occupation' => 'Mother Occupation',
			'mother_income' => 'Mother Income(Annual)',
